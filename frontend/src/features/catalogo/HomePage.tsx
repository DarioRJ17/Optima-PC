...
import { ProductCardView } from '@/shared/components/common'
import { toProductCard, type CatalogSectionKey } from '@/shared/catalog-utils'
import type { AuthMode, CatalogPremontado, SelectedFilters } from '@/shared/types'
